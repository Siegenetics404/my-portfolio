...
export default function Education() {
    return (
        <section className="mt-16 max-w-3xl">
            ...
            {/* School card */}
            <div className="mt-8 border border-neutral-200 dark:border-neutral-800 rounded-lg p-5 sm:p-6">
                {/* Logo + school name */}
                ...
                <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-900">
                    <p className="text-[11px] font-medium text-neutral-400 dark:text-neutral-600 uppercase tracking-wide mb-1.5">
                        Thesis
                    </p>
                ...
                {/* Relevant coursework */}
                <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-900">
                    <p className="text-[11px] font-medium text-neutral-400 dark:text-neutral-600 uppercase tracking-wide mb-3">
                        Relevant Coursework
                    </p>
