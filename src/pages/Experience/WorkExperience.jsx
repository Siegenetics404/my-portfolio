            ...
            <div className="flex flex-col gap-4 mt-8">
                {WORK_EXPERIENCE.map((job) => (
                    <div
                        ...
                        className="border border-neutral-200 rounded-lg p-5 sm:p-6"
                    >
                        ...
                        <ul className="mt-4 pt-4 border-t border-neutral-100 flex flex-col gap-2.5">
                            {job.highlights.map((point, i) => (
                                <li
                                    key={i}
                                    className="text-sm text-neutral-600 leading-relaxed flex gap-2.5"
                                >
